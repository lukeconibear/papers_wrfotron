...
# ------------------------------------------------------------------------------
# WRFotron
chainDir=/nobackup/earlacoa/code/WRFotron2.0_paper_aia_china_policy_t18
version=0.1
...
emissDir=/nobackup/earlacoa/emissions/EDGAR-HTAP2_MEIC2015/MOZART_t18
#emissDir=/nobackup/earlacoa/emissions/CAMS-GLOB-ANT-0.1deg-v4.1-R1.1/with_date_2016/t18
...
# ------------------------------------------------------------------------------
# run folder
workDir=/nobackup/earlacoa/paper_aia_china_policy_t18/run
# output folder
archiveRootDir=/nobackup/earlacoa/paper_aia_china_policy_t18/output
# restart folder
restartRootDir=/nobackup/earlacoa/paper_aia_china_policy_t18/restart
