...
chainDir=/home/ufaserv1_i/pmlac/wrf_new/WRFotron_no-res
...
# Changing to sector specific EDGAR-HTAP2 emissions
emissInpFile=emis_edgarhtap2_mozmos_no-res.inp
...
workDir=/nobackup/pmlac/wrf-chem_2014_with-finn_no-res/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/pmlac/wrf-chem_2014_with-finn_no-res/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/pmlac/wrf-chem_2014_with-finn_no-res/restart
