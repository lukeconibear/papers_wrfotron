...
/bin/csh ./link_grib.csh ${metDir}/ecmwf_global_pressurelevels_20141101_20150102.grib ${metDir}/ecmwf_global_surface_20141101_20150102.grib
...
#/bin/csh ./link_grib.csh ${metDir}/ecmwf_global_pressurelevels_20150501_20150901.grib ${metDir}/ecmwf_global_surface_20150501_20150901.grib
...
# -----------------------------------------------------------------------------
# 4.a) emissions - China = MEIC / surrounding = EDGARHTAP2.2 or CAMS MEIC 2016 v4.1 R4.1
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 4.a) anthropogenic emissions - China = MEIC / PRD / surrounding = EDGARHTAP2.2
# -----------------------------------------------------------------------------
...
# first run for EDGARHTAP2_MEIC for domains 1 and 2
#./anthro_emis < anthro_emis.inp > anthro_emis.out
#mv wrfchemi_00z_d01 wrfchemi_00z_d01_edgarhtap_meic
#mv wrfchemi_12z_d01 wrfchemi_12z_d01_edgarhtap_meic
#mv wrfchemi_00z_d02 wrfchemi_00z_d02_edgarhtap_meic
#mv wrfchemi_12z_d02 wrfchemi_12z_d02_edgarhtap_meic
#rm -f wrfchemi_00z_d03
#rm -f wrfchemi_12z_d03

# then run for PRD for domain 3 (replaced the d03 from previous step)
#./anthro_emis < ${chainDir}/emis_prdei_mozmos.inp > anthro_emis_prdei.out
#rm -f wrfchemi_00z_d01
#rm -f wrfchemi_12z_d01
#rm -f wrfchemi_00z_d02
#rm -f wrfchemi_12z_d02
#mv wrfchemi_00z_d01_edgarhtap_meic wrfchemi_00z_d01
#mv wrfchemi_12z_d01_edgarhtap_meic wrfchemi_12z_d01
#mv wrfchemi_00z_d02_edgarhtap_meic wrfchemi_00z_d02
#mv wrfchemi_12z_d02_edgarhtap_meic wrfchemi_12z_d02
...
# -----------------------------------------------------------------------------
# 4.a) anthropogenic emissions - India = GBDMAPS / surrounding = EDGARHTAP2.2
# -----------------------------------------------------------------------------
...
#./anthro_emis < ${chainDir}/emis_gbdmapsworkinggroup-edgarhtap-co-nh3-c2h2_mozmos.inp > anthro_emis_edgarhtap.out
...
# MOZART - pre 2018
ln -s ${MOZARTdir}/MZ2014novdec ./moz0000.nc
ln -s ${MOZARTdir}/MZ2015jan ./moz0001.nc
ln -s ${MOZARTdir}/MZ2015feb ./moz0002.nc
