...
# ------------------------------------------------------------------------------
# WRFotron
chainDir=/nobackup/earlacoa/code/WRFotron2.0_paper_aia_china_policy_tra-chn
version=0.1
...
emissDir=/nobackup/earlacoa/emissions/EDGAR-HTAP2_MEIC2015/MOZART_tra-chn
...
# ------------------------------------------------------------------------------
# run folder
workDir=/nobackup/earlacoa/paper_aia_china_policy_tra-chn/run
# output folder
archiveRootDir=/nobackup/earlacoa/paper_aia_china_policy_tra-chn/output
# restart folder
restartRootDir=/nobackup/earlacoa/paper_aia_china_policy_tra-chn/restart
