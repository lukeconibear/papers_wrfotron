...
# ------------------------------------------------------------------------------
# WRFotron
chainDir=/nobackup/earlacoa/code/WRFotron2.0_paper_aia_china_policy_ind-chn
version=0.1
...
emissDir=/nobackup/earlacoa/emissions/EDGAR-HTAP2_MEIC2015/MOZART_ind-chn
...
# ------------------------------------------------------------------------------
# run folder
workDir=/nobackup/earlacoa/paper_aia_china_policy_ind-chn/run
# output folder
archiveRootDir=/nobackup/earlacoa/paper_aia_china_policy_ind-chn/output
# restart folder
restartRootDir=/nobackup/earlacoa/paper_aia_china_policy_ind-chn/restart
