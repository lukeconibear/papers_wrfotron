...
chainDir=/nobackup/earlacoa/code/WRFotron2.0_paper_india_sfi_urb15
...
workDir=/nobackup/earlacoa/paper_india_sfi_urb15_WRFotron2/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/earlacoa/paper_india_sfi_urb15_WRFotron2/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/earlacoa/paper_india_sfi_urb15_WRFotron2/restart
