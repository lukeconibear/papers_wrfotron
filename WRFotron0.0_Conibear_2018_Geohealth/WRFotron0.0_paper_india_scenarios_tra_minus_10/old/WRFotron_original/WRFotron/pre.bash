...
#BSUB -n __nprocPre__                          # number of MPI tasks
...
fileList=( ${metDir}/__startYear__/__startYear__.__startMonth__/fnl___startYear____startMonth____startDay_____startHour___00.grib2 )
...
do
  ...
  fileList=( ${fileList[@]} ${metDir}/${curYear}/${curYear}.${curMonth}/fnl_${curYear}${curMonth}${curDay}_${curHour}_00.grib2 )
done
