...
chainDir=/nobackup/pmlac/code/WRFotron_paper_india_air_quality_emission_scenarios_2014_nps
...
workDir=/nobackup/pmlac/paper_india_air_quality_emission_scenarios_2014_nps/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/pmlac/paper_india_air_quality_emission_scenarios_2014_nps/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/pmlac/paper_india_air_quality_emission_scenarios_2014_nps/restart
