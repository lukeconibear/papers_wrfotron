...
chainDir=/nobackup/pmlac/code/WRFotron_paper_india_air_quality_emission_scenarios_ene_minus_10
...
workDir=/nobackup/pmlac/paper_india_air_quality_emission_scenarios_2014_ene_minus_10/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/pmlac/paper_india_air_quality_emission_scenarios_2014_ene_minus_10/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/pmlac/paper_india_air_quality_emission_scenarios_2014_ene_minus_10/restart
