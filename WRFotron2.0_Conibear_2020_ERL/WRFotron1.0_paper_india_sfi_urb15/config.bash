...
chainDir=/nobackup/earlacoa/code/WRFotron1.0_paper_india_sfi_urb15
...
emissDir=/nobackup/earlacoa/emissions/GBDMAPSWorkingGroup_OTHRsplit/mozartmosaic_urb15
...
workDir=/nobackup/earlacoa/paper_india_sfi_urb15/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/earlacoa/paper_india_sfi_urb15/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/earlacoa/paper_india_sfi_urb15/restart
