...
chainDir=/nobackup/earlacoa/code/WRFotron1.0_paper_india_sfi_even15
...
workDir=/nobackup/earlacoa/paper_india_sfi_even15/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/earlacoa/paper_india_sfi_even15/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/earlacoa/paper_india_sfi_even15/restart
