...
chainDir=/nobackup/earlacoa/code/WRFotron1.0_paper_india_sfi_alllpg
...
emissDir=/nobackup/earlacoa/emissions/GBDMAPSWorkingGroup_OTHRsplit/mozartmosaic_alllpg
...
workDir=/nobackup/earlacoa/paper_india_sfi_alllpg/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/earlacoa/paper_india_sfi_alllpg/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/earlacoa/paper_india_sfi_alllpg/restart
