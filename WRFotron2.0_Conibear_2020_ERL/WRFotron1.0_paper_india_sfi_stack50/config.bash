...
chainDir=/nobackup/earlacoa/code/WRFotron1.0_paper_india_sfi_stack50
...
emissDir=/nobackup/earlacoa/emissions/GBDMAPSWorkingGroup_OTHRsplit/mozartmosaic_stack50
...
workDir=/nobackup/earlacoa/paper_india_sfi_stack50/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/earlacoa/paper_india_sfi_stack50/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/earlacoa/paper_india_sfi_stack50/restart
