...
chainDir=/nobackup/earlacoa/code/WRFotron1.0_paper_india_sfi_baseline
...
WRFdir=/nobackup/earlacoa/code/WRFChem3.7.1
...
emissDir=/nobackup/earlacoa/emissions/GBDMAPSWorkingGroup_OTHRsplit/mozartmosaic_baseline
...
workDir=/nobackup/earlacoa/paper_india_sfi_baseline/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/earlacoa/paper_india_sfi_baseline/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/earlacoa/paper_india_sfi_baseline/restart
