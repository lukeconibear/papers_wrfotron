...
chainDir=/nobackup/pmlac/code/WRFotron_paper_india_air_quality_contributions_health_sector_no-ind
...
workDir=/nobackup/pmlac/paper_india_air_quality_contributions_health_sector_2014_no-ind/run
# where the WRF output will be stored - also maybe /glade/scratch/something...
archiveRootDir=/nobackup/pmlac/paper_india_air_quality_contributions_health_sector_2014_no-ind/output
# where the WRF restart files will be stored - also maybe /glade/scratch/something...
restartRootDir=/nobackup/pmlac/paper_india_air_quality_contributions_health_sector_2014_no-ind/restart
