...
#BSUB -n __nprocMain__                        # number of MPI tasks
...
#$ -pe ib __nprocMain__              # Specifies a job for parallel programs using MPI, nprocPre is the number of cores to be used by the parallel job
